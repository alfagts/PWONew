...
Icons[131072] = { tooltip = tr('You are under fast attack effect'),              path = '/images/game/states/fast_attack',           id = 'condition_fast_attack' }
...
soulLabel = nil
capLabel = nil
healthTooltip     = 'Sua vida está em %d de %d.'
manaTooltip       = 'Sua mana está em %d de %d.'
...
function onSoulChange(localPlayer, soul)
  soulLabel:setText(tr('Fatigue') .. ': ' .. soul)
end
